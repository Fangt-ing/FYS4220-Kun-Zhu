...
module nios2_system_mm_interconnect_0 (
	...
	wire  [97:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> pio_led_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // pio_led_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [8:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> pio_led_s1_agent:cp_channel
	...
	wire  [97:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> pio_sw_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // pio_sw_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [8:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> pio_sw_s1_agent:cp_channel
	...
	wire  [97:0] pio_led_s1_agent_rp_data;                                                  // pio_led_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [97:0] pio_sw_s1_agent_rp_data;                                                   // pio_sw_s1_agent:rp_data -> router_007:sink_data
	...
	wire         pio_sw_s1_agent_rdata_fifo_src_valid;                                      // pio_sw_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] pio_sw_s1_agent_rdata_fifo_src_data;                                       // pio_sw_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         pio_sw_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_005:in_0_ready -> pio_sw_s1_agent:rdata_fifo_src_ready
