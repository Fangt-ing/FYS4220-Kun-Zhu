...
module nios2_system_mm_interconnect_0 (
	...
	wire  [95:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> pio_led_s1_agent:cp_data
	...
	wire  [96:0] pio_sw_s1_agent_rf_source_data;                                            // pio_sw_s1_agent:rf_source_data -> pio_sw_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] pio_sw_s1_agent_rsp_fifo_out_data;                                         // pio_sw_s1_agent_rsp_fifo:out_data -> pio_sw_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> pio_sw_s1_agent:cp_data
	...
	wire  [96:0] pio_irq_s1_agent_rf_source_data;                                           // pio_irq_s1_agent:rf_source_data -> pio_irq_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] pio_irq_s1_agent_rsp_fifo_out_data;                                        // pio_irq_s1_agent_rsp_fifo:out_data -> pio_irq_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                     // cmd_mux_005:src_valid -> pio_irq_s1_agent:cp_valid
	wire  [95:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> pio_irq_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // pio_irq_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> pio_irq_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                             // cmd_mux_005:src_startofpacket -> pio_irq_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                               // cmd_mux_005:src_endofpacket -> pio_irq_s1_agent:cp_endofpacket
	...
	wire  [95:0] pio_led_s1_agent_rp_data;                                                  // pio_led_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [95:0] pio_sw_s1_agent_rp_data;                                                   // pio_sw_s1_agent:rp_data -> router_006:sink_data
	...
	wire         pio_irq_s1_agent_rp_valid;                                                 // pio_irq_s1_agent:rp_valid -> router_007:sink_valid
	wire  [95:0] pio_irq_s1_agent_rp_data;                                                  // pio_irq_s1_agent:rp_data -> router_007:sink_data
	wire         pio_irq_s1_agent_rp_ready;                                                 // router_007:sink_ready -> pio_irq_s1_agent:rp_ready
	wire         pio_irq_s1_agent_rp_startofpacket;                                         // pio_irq_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         pio_irq_s1_agent_rp_endofpacket;                                           // pio_irq_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         pio_irq_s1_agent_rdata_fifo_src_valid;                                     // pio_irq_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] pio_irq_s1_agent_rdata_fifo_src_data;                                      // pio_irq_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         pio_irq_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_005:in_0_ready -> pio_irq_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                         // avalon_st_adapter_005:out_0_valid -> pio_irq_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                          // avalon_st_adapter_005:out_0_data -> pio_irq_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                         // pio_irq_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                         // avalon_st_adapter_005:out_0_error -> pio_irq_s1_agent:rdata_fifo_sink_error
